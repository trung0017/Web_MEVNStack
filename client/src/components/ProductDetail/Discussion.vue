        ...
        <b-row class="justify-content-center mt-5">
            <b-col sm="12" xl="8">
                <div class="d-flex flex-row justify-content-between">
                    ...
                    <b-button size="md" variant="success" @click="newDiscussionModal = true">Add new discussion
                    </b-button>
                </div>
                <b-modal title="New discussion" v-model="newDiscussionModal" centered ok-title="Post"
                    ok-variant="success" @ok="newDiscussion" cancel-title="Discard">
                    <b-form-textarea v-model="discussionText" placeholder="What's in your mind ?">
                    </b-form-textarea>
                </b-modal>
                ...
                <div v-else>
                    ...
                    <b-pagination v-model="currentPage" :per-page="itemsPerPage" :total-rows="posts.length"
                        aria-controls="discussion-list" align="center" pills></b-pagination>
                </div>
            </b-col>
        </b-row>
    </div>
