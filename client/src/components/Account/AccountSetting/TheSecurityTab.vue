<template>
    <div class="d-flex flex-column align-items-start m-3">
        <h1 class="display-7 info-header"><b style="color: black;">Password</b></h1>
        <div class="data-row">
        ...
        <b-button variant="primary" class="align-self-end" :class="{ 'update-loading': changePasswordLoading }"
